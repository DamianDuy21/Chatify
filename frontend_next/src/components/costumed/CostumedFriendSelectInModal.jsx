...
import FriendCard_FriendSelectInModal from "@/components/cards/FriendCard_FriendSelectInModal";
...
const CostumedFriendSelectInModal = ({
  ...
  const t = useTranslations("Components.costumedFriendSelectInModal");
  return (
