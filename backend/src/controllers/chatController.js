...
// export const updateMemberRoleInGroupController = async (req, res) => {
//   const conversationId = req.params.id;
//   const { memberId, isKeyMember = true } = req.body;
//   try {
//     if (!memberId || typeof isKeyMember !== "boolean") {
//       return res.status(400).json({ message: "Invalid member data" });
//     }
//     const conversation = await Conversation.findById(conversationId);
//     if (!conversation || conversation.type !== "group") {
...
//       return res.status(404).json({ message: "Member not found in group" });
//     }
//     member.isKeyMember = isKeyMember;
//     await member.save();
//     return res.status(200).json({
//       success: true,
//       data: {
...
//         },
//       },
//       message: "Cập nhật vai trò thành viên trong nhóm thành công",
//     });
//   } catch (error) {
//     console.error("Error updating member role in group:", error);
//     return res.status(500).json({ message: "Lỗi máy chủ nội bộ" });
//   }
// };

// Giả sử đã import các model và đã kết nối mongoose
// import mongoose from "mongoose";
// import Conversation from "../models/Conversation.js";
// import ConversationMember from "../models/ConversationMember.js";
// import ConversationSetting from "../models/ConversationSetting.js";
